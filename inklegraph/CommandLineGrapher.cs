...
namespace Ink
{
    internal class CommandLineGrapher
    {
        public Story story { get; protected set; }
        protected Dictionary<string, int> namedNodes { get; set; }

        public CommandLineGrapher(Story story, Compiler compiler = null)
        {
            this.story = story;
            _compiler = compiler;
        ...
        internal void FollowStory (ref List<object> jsonRoot) {
            ...
            Ink.Runtime.Pointer _prevPointer = story.state.previousPointer;
            Ink.Runtime.Pointer _currPointer = story.state.currentPointer;
        ...
        public void Render(Dictionary<string, object> jsonObject)
        {
